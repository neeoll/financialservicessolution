...
export default function EnterReceiveMoney({navigation}) {
    ...
    <RNContainer useScroll edges={[]} style={styles.container}>
      <ImageBackground
        ...
        <RNText style={styles.enterAmountText}>
          {Strings.enterYourRequestAmount}
        </RNText>
        ...
        <RNButton
          onPress={() => navigationTo(navigation, Screens.ReceiveMoneyQr)}
          title={Strings.receiveMoney}
          round
